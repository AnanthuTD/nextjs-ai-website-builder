		...
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className="min-w-3/5">
				<DialogHeader>
					...
					<DialogDescription>
						<strong>Note:</strong> For the best results, provide a clear and
						detailed prompt describing your vision (e.g., "A cozy e-commerce
						site for handmade candles with warm colors"). This creates a unique
						design tailored to you, rather than relying on templates.
						<br />
						<br />
					</DialogDescription>
				</DialogHeader>
				...
				<Button onClick={handleGenerate}>
					Submit <Loader state={submitting} />{" "}
				</Button>
			</DialogContent>
		</Dialog>
	);
